...
coverage of `game\**` + `io\**` is **24.3%** — a floor, not a grade. The `io.TWS*` streams (0%),
`LynxLevel` (1.7%) and `LynxCreatureList` (6.1%) are the biggest gaps. No CI gate; see CLAUDE.md §4.
