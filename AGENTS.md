...
coverage of `game\**` + `io\**` is **30.5%** — a floor, not a grade. `game\MS\**` (17.0%) is now the
least-covered ruleset, behind Lynx (37.4%); the `io.TWS*` streams are still at 0%. No CI gate; see
CLAUDE.md §4.
